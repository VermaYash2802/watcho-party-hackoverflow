...
```
> git clone https://github.com/chinvib66/watcho-party-dishathon.git
> cd watcho-party-dishathon
```
...
If you have docker installed, make sure docker service is running
